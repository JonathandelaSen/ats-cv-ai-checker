...
test("interview question UI is reachable and linked from CVs and offers", () => {
  ...
  assert.match(questionsView, /interviewQuestions/);
  assert.match(questionsView, /searchPlaceholder/);
  assert.match(questionsView, /saveWithoutAI/);
  assert.match(questionsView, /createWithAI/);
  assert.match(questionsView, /modelLabel/);
  assert.match(questionsView, /generateWithAI/);
  assert.match(questionsView, /saveManualChanges/);
  assert.match(questionsView, /editWithAI/);
  assert.match(questionsView, /cvFilter/);
  assert.match(questionsView, /analysisFilter/);
  assert.match(cvLibrary, /associatedQuestions/);
  assert.match(interviewTab, /analysisDetail\.interview/);
  assert.match(interviewTab, /saveWithoutAI/);
  assert.match(interviewTab, /createWithAI/);
  assert.match(interviewTab, /modelLabel/);
  ...
  assert.match(trackingTab, /analysisDetail\.tracking/);
});
